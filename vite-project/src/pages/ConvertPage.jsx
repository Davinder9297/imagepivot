...
const supportedVectorInkscape = ['svg', 'eps', 'pdf', 'cdr']; // use inkscape CLI
const supportedAnimationFFmpeg = ['gif', 'mp4', 'webm', 'mov']; // video/animation formats
const supportedGM = ['bmp', 'gif', 'tiff', 'psd', 'ico', 'cur', 'pcx', 'tga', 'xcf', 'dds'];
const RAWFormats = ['cr2','nef','arw','dng'];

const validFormats = [
  ...new Set([
    ...supportedRasterSharp,
    ...supportedVectorInkscape,
    ...supportedAnimationFFmpeg,
    ...supportedGM,
  ])
];
...
const handleConvert = async (e) => {
  ...
  try {
    ...
    // Create URL for the converted image blob
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-teal-600 mb-2">Convert Image</h1>
