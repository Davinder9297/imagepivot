...
const ConvertAudioPage = () => {
  ...
  const validFormats = ['wav', 'aiff', 'pcm', 'mp3', 'aac', 'ogg', 'flac', 'alac', 'm4a', 'opus', 'amr'];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-teal-600 mb-2">Convert Audio</h1>
          <p className="text-lg text-black max-w-2xl mx-auto">
            Convert your audio files to different formats while maintaining quality
          </p>
        </div>
            ...
            <div className="p-6">
              <form onSubmit={handleConvert} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* Small Preview Audio Player */}
                  {previewUrl && (
                    <div className="mt-4 flex justify-center">
                      <audio controls src={previewUrl} className="w-full max-w-md rounded-lg" />
                    </div>
                  )}
                  ...
                  <div className="flex justify-center">
                    <button
                      ...
                      className={`inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-200 ${
                        loading || !audio ? "opacity-50 cursor-not-allowed" : "hover:scale-105"
                      }`}
                    >
                      {loading ? (
                        <>
